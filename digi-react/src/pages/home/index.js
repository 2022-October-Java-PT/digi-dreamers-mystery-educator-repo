...
const HomePage = () => {
    ...
    return (
        ...
        <center>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/21iEBbsuuTI?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </center>
        <center>
        <h2>Take a virtual tour of the MET!</h2>
        <p>
